...
class Tracker:
    ...
    def get_object_tracks(self,frames,read_from_stop=False, stop_path=None):
        
        if read_from_stop and stop_path is not None and os.path.exists(stop_path):
    ...
    def draw_team_ball_control(self,frame,frame_num,team_ball_control):
        ...
        #get the number of time each time had ball 
